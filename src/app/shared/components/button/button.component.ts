...
export class ButtonComponent implements OnInit {
    ...
    baseClasses = 'font-semibold transition-all focus-visible:outline-none flex items-center justify-center focus-visible:ring-2 focus-visible:ring-offset-2 active:translate-y-px disabled:pointer-events-none disabled:opacity-50';
